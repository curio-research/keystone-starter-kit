...
type S2C_KillEnemyMessage struct {
...
func (x *S2C_KillEnemyMessage) Reset() {
	*x = S2C_KillEnemyMessage{}
...
func (x *S2C_KillEnemyMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*S2C_KillEnemyMessage) ProtoMessage() {}

func (x *S2C_KillEnemyMessage) ProtoReflect() protoreflect.Message {
	mi := &file_main_proto_msgTypes[0]
...
// Deprecated: Use S2C_KillEnemyMessage.ProtoReflect.Descriptor instead.
func (*S2C_KillEnemyMessage) Descriptor() ([]byte, []int) {
	return file_main_proto_rawDescGZIP(), []int{0}
}

func (x *S2C_KillEnemyMessage) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_main_proto_rawDesc = []byte{
	...
	,
}
...
var file_main_proto_goTypes = []interface{}{
	(CMD)(0),                     // 0: pb_main.CMD
	(*S2C_KillEnemyMessage)(nil), // 1: pb_main.S2C_KillEnemyMessage
...
func file_main_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_main_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*S2C_KillEnemyMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
